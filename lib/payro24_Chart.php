...
class payro24_Chart
{
    ...
    {
        if (!empty($_POST)) {
            check_admin_referer("search", "gf_payro24_chart");
        }

        $form_id = rgget("id");
        $form = RGFormsModel::get_form_meta($form_id);
        if (empty($form) || !is_numeric($form_id) || intval($form_id) != $form_id) {
            die(__('فرم درخواستی وجود ندارد.', 'gravityformspayro24'));
        }
        ?>
        <style type="text/css">.payro24_graph_container{clear:both;padding-left:5px;min-width:789px;margin-right:50px}.payro24_message_container{clear:both;padding-left:5px;text-align:center;padding-top:120px;border:1px solid #CCC;background-color:#FFF;width:100%;height:200px}.payro24_summary_container{margin:30px 60px 30px 50px;text-align:center;min-width:740px}.payro24_summary_item{width:180px;height:70px;border-radius:5px;background-color:#FFF;border:1px solid #CCC;padding:14px 8px;margin:6px 3px 6px 0;display:-moz-inline-stack;display:inline-block;zoom:1;text-align:center}.tooltipbox_blue,.tooltipbox_green,.tooltipbox_orang,.tooltipbox_red{padding:5px 10px 5px 5px;border-radius:4px;color:#fff}.payro24_summary_value{font-size:20px;margin:5px 0}.payro24_summary_title{height:40px}.tooltipbox_blue{background:#0074A2}.tooltipbox_green{background:#50B432}.tooltipbox_orang{background:#EDC240}.tooltipbox_red{background:#AA4643}.ui-datepicker-title option,.ui-datepicker-title select{font-size:11px!important}.ui-datepicker th{font-size:12px!important}</style>
        <?php
        ...
        <div class="wrap">
            <ul class="subsubsub">
                <li><a class="<?php echo (!rgget("tab") || rgget("tab") == "today") ? "current" : "" ?>"
                       href="?page=gf_payro24&view=stats&id=<?php echo rgget('id') ?>"><?php _e("امروز", "gravityformspayro24"); ?></a>
                    |
                </li>
                <li><a class="<?php echo rgget("tab") == "yesterday" ? "current" : "" ?>"
                       href="?page=gf_payro24&view=stats&id=<?php echo rgget('id') ?>&tab=yesterday"><?php _e("دیروز", "gravityformspayro24"); ?></a>
                    |
                </li>
                <li><a class="<?php echo rgget("tab") == "last7days" ? "current" : "" ?>"
                       href="?page=gf_payro24&view=stats&id=<?php echo rgget('id') ?>&tab=last7days"><?php _e("هفت روز گذشته", "gravityformspayro24"); ?></a>
                    |
                </li>
                <li><a class="<?php echo rgget("tab") == "thisweek" ? "current" : "" ?>"
                       href="?page=gf_payro24&view=stats&id=<?php echo rgget('id') ?>&tab=thisweek"><?php _e("هفته جاری", "gravityformspayro24"); ?></a>
                    |
                </li>
                <li><a class="<?php echo rgget("tab") == "last30days" ? "current" : "" ?>"
                       href="?page=gf_payro24&view=stats&id=<?php echo rgget('id') ?>&tab=last30days"><?php _e("30 روز گذشته", "gravityformspayro24"); ?></a>
                    |
                </li>
                <li><a class="<?php echo rgget("tab") == "thismonth" ? "current" : "" ?>"
                       href="?page=gf_payro24&view=stats&id=<?php echo rgget('id') ?>&tab=thismonth"><?php _e("ماه جاری", "gravityformspayro24"); ?></a>|
                </li>
                <li><a class="<?php echo rgget("tab") == "lastmonth" ? "current" : "" ?>"
                       href="?page=gf_payro24&view=stats&id=<?php echo rgget('id') ?>&tab=lastmonth"><?php _e("ماه قبل", "gravityformspayro24"); ?></a>|
                </li>
                <li><a class="<?php echo rgget("tab") == "last2month" ? "current" : "" ?>"
                       href="?page=gf_payro24&view=stats&id=<?php echo rgget('id') ?>&tab=last2month"><?php _e("2 ماه اخیر", "gravityformspayro24"); ?></a>
                    |
                </li>
                <li><a class="<?php echo rgget("tab") == "last3month" ? "current" : "" ?>"
                       href="?page=gf_payro24&view=stats&id=<?php echo rgget('id') ?>&tab=last3month"><?php _e("3 ماه اخیر", "gravityformspayro24"); ?></a>
                    |
                </li>
                <li><a class="<?php echo rgget("tab") == "last6month" ? "current" : "" ?>"
                       href="?page=gf_payro24&view=stats&id=<?php echo rgget('id') ?>&tab=last6month"><?php _e("6 ماه اخیر", "gravityformspayro24"); ?></a>
                    |
                </li>
                <li><a class="<?php echo rgget("tab") == "last9month" ? "current" : "" ?>"
                       href="?page=gf_payro24&view=stats&id=<?php echo rgget('id') ?>&tab=last9month"><?php _e("9 ماه اخیر", "gravityformspayro24"); ?></a>
                    |
                </li>
                <li><a class="<?php echo rgget("tab") == "last12month" ? "current" : "" ?>"
                       href="?page=gf_payro24&view=stats&id=<?php echo rgget('id') ?>&tab=last12month"><?php _e("یک سال اخیر", "gravityformspayro24"); ?></a>
                    |
                </li>
                <li><a class="<?php echo rgget("tab") == "spring" ? "current" : "" ?>"
                       href="?page=gf_payro24&view=stats&id=<?php echo rgget('id') ?>&tab=spring"><?php _e("بهار", "gravityformspayro24"); ?></a>|
                </li>
                <li><a class="<?php echo rgget("tab") == "summer" ? "current" : "" ?>"
                       href="?page=gf_payro24&view=stats&id=<?php echo rgget('id') ?>&tab=summer"><?php _e("تابستان", "gravityformspayro24"); ?></a>|
                </li>
                <li><a class="<?php echo rgget("tab") == "fall" ? "current" : "" ?>"
                       href="?page=gf_payro24&view=stats&id=<?php echo rgget('id') ?>&tab=fall"><?php _e("پاییز", "gravityformspayro24"); ?></a>|
                </li>
                <li><a class="<?php echo rgget("tab") == "winter" ? "current" : "" ?>"
                       href="?page=gf_payro24&view=stats&id=<?php echo rgget('id') ?>&tab=winter"><?php _e("زمستان", "gravityformspayro24"); ?></a>|
                </li>
                <li><a class="<?php echo rgget("tab") == "thisyear" ? "current" : "" ?>"
                       href="?page=gf_payro24&view=stats&id=<?php echo rgget('id') ?>&tab=thisyear"><?php _e("امسال", "gravityformspayro24"); ?></a>
                </li>
                <br/><br/>
                <form method="post"
                      action="?page=gf_payro24&view=stats&id=<?php echo rgget("id") ?>&tab=selection"><?php wp_nonce_field("search", "gf_payro24_chart") ?>
                    <span><?php _e('از تاریخ', 'gravityformspayro24') ?></span>
                    <input type="text" name="min" class="datepicker"
                           value="<?php echo sanitize_text_field(rgpost('min')); ?>" autocomplete="off"/>
                    <span style="margin-right:15px"><?php _e('تا تاریخ', 'gravityformspayro24') ?></span>
                    ...
                    <input type="submit" class="button-primary button" name="submit"
                           value="<?php _e('انتخاب', 'gravityformspayro24') ?>"><br>
                </form>
            </ul>
            ...
            <div class="clear"></div>
            <h2><?php _e(" درآمد از درگاه payro24 برای فرمِ ", "gravityformspayro24") ?><?php echo '"' . $form["title"] . '"'; ?></h2>
            <div>
                <?php if (empty($chart_info["series"])) { ?>
                    <div
                            class="payro24_message_container"><?php _e("موردی یافت نشد . ", "gravityformspayro24") ?></div>
                <?php } else { ?>
                    <div class="payro24_graph_container">
                        <div id="graph_placeholder" style="width:100%;height:300px;"></div>
                    </div>
                    <?php
                }

                $sales_label = __("تعداد کل پرداخت های  payro24 این فرم", "gravityformspayro24");

                $transaction_totals = payro24_DB::get_transaction_totals($form_id);
                ...
                ?>
                <div class="payro24_summary_container">
                    <div class="payro24_summary_item">
                        <div
                                class="payro24_summary_title"><?php _e('جمع پرداخت های  payro24 این فرم', 'gravityformspayro24') ?></div>
                        <div
                                class="payro24_summary_value"><?php echo GF_tr_num(GFCommon::to_money($total_revenue), 'fa') ?></div>
                    </div>

                    <div class="payro24_summary_item">
                        <div class="payro24_summary_title"><?php echo $chart_info["revenue_label"] ?></div>
                        <div class="payro24_summary_value"><?php echo GF_tr_num($chart_info["revenue"], 'fa') ?></div>
                    </div>

                    <div class="payro24_summary_item">
                        <div class="payro24_summary_title"><?php echo $chart_info["mid_label"] ?></div>
                        <div class="payro24_summary_value"><?php echo GF_tr_num($chart_info["mid"], 'fa') ?></div>
                    </div>

                    <div class="payro24_summary_item">
                        <div class="payro24_summary_title"><?php echo $sales_label ?></div>
                        <div class="payro24_summary_value"><?php echo GF_tr_num($total_sales, 'fa') ?></div>
                    </div>

                    <div class="payro24_summary_item">
                        <div class="payro24_summary_title"><?php echo $chart_info["sales_label"] ?></div>
                        <div class="payro24_summary_value"><?php echo GF_tr_num($chart_info["sales"], 'fa') ?></div>
                    </div>

                    <div class="payro24_summary_item">
                        <div class="payro24_summary_title"><?php echo $chart_info["midt_label"] ?></div>
                        <div class="payro24_summary_value"><?php echo GF_tr_num($chart_info["midt"], 'fa') ?></div>
                    </div>
            ...
            <hr>
            <div class="clear"></div>
            <h2><?php _e(" درآمد از همه روشها برای فرمِ ", "gravityformspayro24") ?><?php echo '"' . $form["title"] . '"'; ?></h2>
            <div>
                ...
                $sales_label = __("تعداد کل پرداخت های  همه روشهای این فرم", "gravityformspayro24");

                $transaction_totals = payro24_DB::get_transaction_totals_gateways($form_id);
                $total_sales = empty($transaction_totals["active"]["transactions"]) ? 0 : $transaction_totals["active"]["transactions"];
                $total_revenue = empty($transaction_totals["active"]["revenue"]) ? 0 : $transaction_totals["active"]["revenue"];
                ?>
                ...
                <div class="payro24_summary_container">
                    ...
                    <div class="payro24_summary_item">
                        <div
                                class="payro24_summary_title"><?php _e("جمع پرداخت های  همه روشهای این فرم", "gravityformspayro24") ?></div>
                        <div
                                class="payro24_summary_value"><?php echo GF_tr_num(GFCommon::to_money($total_revenue), 'fa') ?></div>
                    </div>

                    <div class="payro24_summary_item">
                        <div class="payro24_summary_title"><?php echo $chart_info_gateways["revenue_label"] ?></div>
                        <div
                                class="payro24_summary_value"><?php echo GF_tr_num($chart_info_gateways["revenue"], 'fa') ?></div>
                    </div>

                    <div class="payro24_summary_item">
                        <div class="payro24_summary_title"><?php echo $chart_info_gateways["mid_label"] ?></div>
                        <div
                                class="payro24_summary_value"><?php echo GF_tr_num($chart_info_gateways["mid"], 'fa') ?></div>
                    </div>
                    ...
                    <div class="payro24_summary_item">
                        <div class="payro24_summary_title"><?php echo $chart_info_gateways["sales_label"] ?></div>
                        <div
                                class="payro24_summary_value"><?php echo GF_tr_num($chart_info_gateways["sales"], 'fa') ?></div>
                    </div>

                    <div class="payro24_summary_item">
                        <div class="payro24_summary_title"><?php echo $chart_info_gateways["midt_label"] ?></div>
                        <div
                                class="payro24_summary_value"><?php echo GF_tr_num($chart_info_gateways["midt"], 'fa') ?></div>
                    </div>
            ...
            <hr>
            <div class="clear"></div>
            <h2><?php _e(" کل درآمد های payro24", "gravityformspayro24") ?></h2>
            <div>
                ...
                $sales_label = __("تعداد کل پرداخت های درگاه payro24", "gravityformspayro24");

                $transaction_totals = payro24_DB::get_transaction_totals_this_gateway();
                $total_sales = empty($transaction_totals["active"]["transactions"]) ? 0 : $transaction_totals["active"]["transactions"];
                $total_revenue = empty($transaction_totals["active"]["revenue"]) ? 0 : $transaction_totals["active"]["revenue"];
                ?>
                <div class="payro24_summary_container">
                    <div class="payro24_summary_item">
                        <div
                                class="payro24_summary_title"><?php _e("جمع پرداخت های  همه فرمهای payro24", "gravityformspayro24") ?></div>
                        <div
                                class="payro24_summary_value"><?php echo GF_tr_num(GFCommon::to_money($total_revenue), 'fa') ?></div>
                    </div>

                    <div class="payro24_summary_item">
                        <div class="payro24_summary_title"><?php echo $chart_info_hannan["revenue_label"] ?></div>
                        <div
                                class="payro24_summary_value"><?php echo GF_tr_num($chart_info_hannan["revenue"], 'fa') ?></div>
                    </div>

                    <div class="payro24_summary_item">
                        <div class="payro24_summary_title"><?php echo $chart_info_hannan["mid_label"] ?></div>
                        <div
                                class="payro24_summary_value"><?php echo GF_tr_num($chart_info_hannan["mid"], 'fa') ?></div>
                    </div>
                    ...
                    <div class="payro24_summary_item">
                        <div class="payro24_summary_title"><?php echo $chart_info_hannan["sales_label"] ?></div>
                        <div
                                class="payro24_summary_value"><?php echo GF_tr_num($chart_info_hannan["sales"], 'fa') ?></div>
                    </div>

                    <div class="payro24_summary_item">
                        <div class="payro24_summary_title"><?php echo $chart_info_hannan["midt_label"] ?></div>
                        <div
                                class="payro24_summary_value"><?php echo GF_tr_num($chart_info_hannan["midt"], 'fa') ?></div>
                    </div>
                </div>
            </div>
            <hr>
            <div class="clear"></div>
            <h2><?php _e(" کل درآمد های سایت ( همه روشها برای همه فرم ها)", "gravityformspayro24") ?></h2>
            <div>
                ...
                $sales_label = __("تعداد کل پرداخت های همه فرمهای سایت", "gravityformspayro24");

                $transaction_totals = payro24_DB::get_transaction_totals_site();
                $total_sales = empty($transaction_totals["active"]["transactions"]) ? 0 : $transaction_totals["active"]["transactions"];
                $total_revenue = empty($transaction_totals["active"]["revenue"]) ? 0 : $transaction_totals["active"]["revenue"];
                ?>
                <div class="payro24_summary_container">
                    <div class="payro24_summary_item">
                        <div
                                class="payro24_summary_title"><?php _e("جمع کل پرداخت های همه فرمهای سایت", "gravityformspayro24") ?></div>
                        <div
                                class="payro24_summary_value"><?php echo GF_tr_num(GFCommon::to_money($total_revenue), 'fa') ?></div>
                    </div>

                    <div class="payro24_summary_item">
                        <div class="payro24_summary_title"><?php echo $chart_info_site["revenue_label"] ?></div>
                        <div
                                class="payro24_summary_value"><?php echo GF_tr_num($chart_info_site["revenue"], 'fa') ?></div>
                    </div>

                    <div class="payro24_summary_item">
                        <div class="payro24_summary_title"><?php echo $chart_info_site["mid_label"] ?></div>
                        <div class="payro24_summary_value"><?php echo GF_tr_num($chart_info_site["mid"], 'fa') ?></div>
                    </div>
                    <div class="payro24_summary_item">
                        <div class="payro24_summary_title"><?php echo $sales_label ?></div>
                        <div class="payro24_summary_value"><?php echo GF_tr_num($total_sales, 'fa') ?></div>
                    ...
                    <div class="payro24_summary_item">
                        <div class="payro24_summary_title"><?php echo $chart_info_site["sales_label"] ?></div>
                        <div
                                class="payro24_summary_value"><?php echo GF_tr_num($chart_info_site["sales"], 'fa') ?></div>
                    </div>

                    <div class="payro24_summary_item">
                        <div class="payro24_summary_title"><?php echo $chart_info_site["midt_label"] ?></div>
                        <div
                                class="payro24_summary_value"><?php echo GF_tr_num($chart_info_site["midt"], 'fa') ?></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <script type="text/javascript">
            ...
            function startShowTooltip(item, graph) {
                if (item) {
                    if (!previousPoint || previousPoint[0] != item.datapoint[0]) {
                        ...
                        jQuery("#payro24_graph_tooltip").remove();
            ...
            <?php if (!empty($chart_info["series"])) :?>
            var payro24_graph_tooltips = <?php echo GF_tr_num($chart_info["tooltips"], 'fa') ?>;
            ...
            jQuery("#graph_placeholder").bind("plothover", function (event, pos, item) {
                startShowTooltip(item, payro24_graph_tooltips);
            });
            <?php endif;?>


            <?php if (!empty($chart_info_hannan["series"])) :?>
            var payro24_graph_tooltip1s1 = <?php echo GF_tr_num($chart_info_hannan["tooltips"], 'fa') ?>;
            ...
            jQuery("#graph_placeholder1").bind("plothover", function (event, pos, item) {
                startShowTooltip(item, payro24_graph_tooltip1s1);
            });
            <?php endif;?>


            <?php if (!empty($chart_info_gateways["series"])) :?>
            var payro24_graph_tooltip2s2 = <?php echo GF_tr_num($chart_info_gateways["tooltips"], 'fa') ?>;
            ...
            jQuery("#graph_placeholder2").bind("plothover", function (event, pos, item) {
                startShowTooltip(item, payro24_graph_tooltip2s2);
            });
            <?php endif;?>


            <?php if (!empty($chart_info_site["series"])) :?>
            var payro24_graph_tooltip3s3 = <?php echo GF_tr_num($chart_info_site["tooltips"], 'fa') ?>;
            ...
            jQuery("#graph_placeholder3").bind("plothover", function (event, pos, item) {
                startShowTooltip(item, payro24_graph_tooltip3s3);
            });
            <?php endif;?>

            function showTooltip(x, y, contents) {
                jQuery('<div id="payro24_graph_tooltip">' + contents + '<div class="tooltip_tip1"></div></div>').css({
                    position: 'absolute',
                    display: 'none',
                    opacity: 1,
                    width: '150px',
    ...
    public static function lastxdays_chart_info($form_id, $chart, $x)
    {
        ...
        if ($chart == 1) {
            ...
            $t = __('payro24 این فرم', 'gravityformspayro24');
            $results = $wpdb->get_results("SELECT CONVERT_TZ(l.payment_date, '+00:00', '{$tz_offset}') as date, sum(l.payment_amount) as amount_sold, count(l.id) as new_sales
                                        FROM " . payro24_DB::get_entry_table_name() . " l
                                        WHERE form_id={$form_id} AND l.status='active' AND l.is_fulfilled=1 AND l.payment_method='payro24'
                                        GROUP BY date(date)
        ...
        if ($chart == 2) {
            ...
            $t = __('همه روشهای این فرم', 'gravityformspayro24');
            $results = $wpdb->get_results("SELECT CONVERT_TZ(l.payment_date, '+00:00', '{$tz_offset}') as date, sum(l.payment_amount) as amount_sold, count(l.id) as new_sales
                                        FROM " . payro24_DB::get_entry_table_name() . " l
        ...
        if ($chart == 3) {
            $c = 'orang';
            $dt = "}";
            $t = __("همه فرمهای payro24", 'gravityformspayro24');
            $results = $wpdb->get_results("SELECT CONVERT_TZ(l.payment_date, '+00:00', '{$tz_offset}') as date, sum(l.payment_amount) as amount_sold, count(l.id) as new_sales
                                        FROM " . payro24_DB::get_entry_table_name() . " l
                                        WHERE l.status='active' AND l.is_fulfilled=1 AND l.payment_method='payro24'
                                        GROUP BY date(date)
                                        ORDER BY payment_date desc");
        }
        ...
        if ($chart == 4) {
            ...
            $t = __("همه فرمهای سایت", 'gravityformspayro24');
            $results = $wpdb->get_results("SELECT CONVERT_TZ(l.payment_date, '+00:00', '{$tz_offset}') as date, sum(l.payment_amount) as amount_sold, count(l.id) as new_sales
                                        FROM " . payro24_DB::get_entry_table_name() . " l
        ...
        if (!empty($results)) {
            ...
            foreach ($results as $result) {
                ...
                $sales_line = "<div class='payro24_tooltip_sales'><span class='payro24_tooltip_heading'>" . __("تعداد پرداخت ", "gravityformspayro24") . ": </span><span class='payro24_tooltip_value'>" . $result->new_sales . "</span></div>";

                $tooltips .= "\"<div class='tooltipbox_" . $c . "'><div class='payro24_tooltip_date'>" . $timeX_tooltips . "</div>{$sales_line}<div class='payro24_tooltip_revenue'><span class='payro24_tooltip_heading'>" . __("پرداختی", "gravityformspayro24") . ": </span><span class='payro24_tooltip_value'>" . GFCommon::to_money($result->amount_sold) . "</span></div></div>\",";
            }
        ...
        if ($x == 7) {
            $n = __('7 روز', 'gravityformspayro24');
            $mid = 7;
        }
        if ($x == 30) {
            $n = __('30 روز', 'gravityformspayro24');
            $mid = 30;
        }

        $sales_label = sprintf(__("تعداد پرداخت های %s گذشته %s", 'gravityformspayro24'), $n, $t);

        $midt = $mid ? $sales_week / $mid : 0;
        $mid = ($mid ? GFCommon::to_money($revenue_week / $mid) : 0) . __(" در روز", 'gravityformspayro24');
        $midt = number_format($midt, 3, '.', '') . __(" در روز", 'gravityformspayro24');
        $midt_label = sprintf(__("میانگین تعداد پرداخت های %s گذشته %s", 'gravityformspayro24'), $n, $t);
        $mid_label = sprintf(__("میانگین پرداخت های %s گذشته %s", 'gravityformspayro24'), $n, $t);
        $revenue_week = GFCommon::to_money($revenue_week);
        $revenue_label = sprintf(__("جمع پرداخت های %s گذشته %s", 'gravityformspayro24'), $n, $t);
    ...
    public static function thisweek_chart_info($form_id, $chart)
    {
        ...
        if ($chart == 4) {
            $c = 'red';
            $dt = "points: { symbol: 'triangle', fillColor: '#AA4643' }, color: '#AA4643'}";
            $t = __("همه فرم های سایت", 'gravityformspayro24');
            $results = $wpdb->get_results("SELECT CONVERT_TZ(l.payment_date, '+00:00', '{$tz_offset}') as date, sum(l.payment_amount) as amount_sold, count(l.id) as new_sales
                                        FROM " . payro24_DB::get_entry_table_name() . " l
                                        WHERE l.status='active' AND l.is_fulfilled=1
                                        GROUP BY date(date)
        ...
        $sales_label = __("تعداد پرداخت های  این هفته ", 'gravityformspayro24') . $t;

        $midt = $sales_week / 7;
        $midt = ($midt ? number_format($midt, 3, '.', '') : 0) . __(" در روز", 'gravityformspayro24');
        $midt_label = __("میانگین تعداد پرداخت های  این هفته ", 'gravityformspayro24') . $t;
        $mid = GFCommon::to_money($revenue_week / 7) . __(" در روز", 'gravityformspayro24');
        $mid_label = __("میانگین پرداخت های این هفته ", 'gravityformspayro24') . $t;
        $revenue_week = GFCommon::to_money($revenue_week);
        $revenue_label = __("جمع پرداخت های  این هفته ", 'gravityformspayro24') . $t;
    ...
    public static function targetmdays_chart_info($form_id, $chart, $xmonth)
    {
        ...
        if (!empty($results)) {
            ...
            if ($xmonth == 1 || $xmonth == 2) {
                ...
                $n = $n . __(" ماه", "gravityformspayro24");
            }
            if ($xmonth == 60 || $xmonth == 3 || $xmonth == 6 || $xmonth == 9 || $xmonth == 12) {
                ...
                $n = $n . __(" ماه اخیر", "gravityformspayro24");

                if ($xmonth == 12) {
                    $n = __(" یکسال اخیر", "gravityformspayro24");
                }
            }
        ...
        if ($xmonth == 60 || $xmonth == 3 || $xmonth == 6 || $xmonth == 9 || $xmonth == 12) {
            ...
            if ($xmonth == 12) {
                $n = __('یک سال اخیر', 'gravityformspayro24');
            }
        }

        $sales_label = __('تعداد پرداخت های  ', 'gravityformspayro24') . $n . ' ' . $t;
        ...
        $midt = number_format($midt, 3, '.', '') . __(" در روز", 'gravityformspayro24');
        $midt_label = __('میانگین تعداد پرداخت های ', 'gravityformspayro24') . $n . ' ' . $t;
        $mid = ($midd ? GFCommon::to_money($revenue_thistday / $midd) : 0) . __(" در روز", 'gravityformspayro24');
        $mid_label = __('میانگین پرداخت های ', 'gravityformspayro24') . $n . ' ' . $t;
        $revenue_label = __('جمع پرداخت های  ', 'gravityformspayro24') . $n . ' ' . $t;
    ...
    public static function tyday_chart_info($form_id, $chart, $day)
    {
        ...
        $date = new DateTime($today);
        if ($day == 1) {
            $n = __("امروز", 'gravityformspayro24');
            $baze = date('m d , Y', $tday);
            $ty = date('Ymd', $tday);
        } else if ($day == 2) {
            $n = __("دیروز", 'gravityformspayro24');
            $date->sub(new DateInterval('P1DT0H0M'));
        ...
        $midt = $sales_today / 24;
        $midt = number_format($midt, 3, '.', '') . __(" در ساعت", "gravityformspayro24");
        $midt_label = __("میانگین تعداد پرداخت های ", "gravityformspayro24") . $n . " " . $t;
        $mid = GFCommon::to_money($revenue_today / 24) . __(" در ساعت", "gravityformspayro24");
        $mid_label = __("میانگین پرداخت های ", "gravityformspayro24") . $n . " " . $t;
    ...
    public static function yearly_chart_info($form_id, $chart)
    {
        ...
        $sales_label = __("تعداد پرداخت های امسال ", "gravityformspayro24") . $t;
        ...
        $midt = number_format($midt, 3, '.', '') . __(" در روز", "gravityformspayro24");
        $midt_label = __("میانگین تعداد پرداخت های امسال ", "gravityformspayro24") . $t;
        $mid = ($midd ? GFCommon::to_money($revenue_yearly / $midd) : 0) . __(" در روز", "gravityformspayro24");
        $mid_label = __("میانگین پرداخت های امسال ", "gravityformspayro24") . $t;
        $revenue_yearly = GFCommon::to_money($revenue_yearly);
        $revenue_label = __("جمع پرداخت های امسال ", "gravityformspayro24") . $t;
    ...
    public static function season_chart_info($form_id, $chart, $season)
    {
        ...
        if ($season == 2) {
            $n = __('تابستان', 'gravityformspayro24');
            $ebtda = $avalesal_t;
        ...
        if ($season == 3) {
            $n = __('پاییز', 'gravityformspayro24');
            $ebtda = $avalesal_t;
        ...
        if ($season == 4) {
            $n = __('زمستان', 'gravityformspayro24');
            $ebtda = $avalesal_t;
        ...
        $midt = ($midt ? number_format($midt, 3, '.', '') : 0) . __(" در روز", 'gravityformspayro24');
        $midt_label = __("میانگین تعداد پرداخت های  ", 'gravityformspayro24') . $n . " " . $t;
        $mid = ($midd ? GFCommon::to_money($revenue_season / $midd) : 0) . __(" در روز", 'gravityformspayro24');
        $mid_label = __("میانگین پرداخت های  ", 'gravityformspayro24') . $n . " " . $t;
        $revenue_label = __("جمع پرداخت های  ", 'gravityformspayro24') . $n . " " . $t;
    ...
    public static function selection_chart_info($form_id, $chart, $min, $max)
    {
        ...
        $sales_label = __("تعداد پرداخت های بازه انتخابی ", 'gravityformspayro24') . $t;

        $midt = $midd ? $sales_today / $midd : 0;
        $midt = number_format($midt, 3, '.', '') . __(" در روز", 'gravityformspayro24');
        $midt_label = __("میانگین تعداد پرداخت های  ", 'gravityformspayro24') . $t . "";
        $mid = ($midd ? GFCommon::to_money($revenue_today / $midd) : 0) . __(" در روز", 'gravityformspayro24');
        $mid_label = __("میانگین پرداخت های  ", 'gravityformspayro24') . $t . "";
        $revenue_today = GFCommon::to_money($revenue_today);
        $revenue_label = __("جمع پرداخت های بازه انتخابی ", 'gravityformspayro24') . $t;
